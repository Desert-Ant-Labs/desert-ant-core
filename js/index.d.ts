 ...
 *  native `dal_*` symbols. Generated by BridgeJS from the `@JS` declarations in
 *  the model's `Web/main.swift`, so `dist/bridge-js.d.ts` is the source of truth
 *  for it; this mirrors that shape for the seams below. Handles are opaque
 *  numbers. */
