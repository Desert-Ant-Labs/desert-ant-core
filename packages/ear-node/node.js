// On-device spoken language identification for JavaScript, server-side (Node).
// This is the `node` conditional-exports entry: the same Ear API as the browser
// build, but natively via the prebuilt Swift core (LiteRT/Core ML under the
// hood) instead of WebAssembly + LiteRT.js. Consumers just `import { Ear }` -
// Node resolves this file, browsers resolve `browser.js`.
//
...
// @desert-ant-labs/core/node, and the public API is `ear.js`, shared with the
