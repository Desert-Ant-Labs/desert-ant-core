// On-device NSFW image detection for JavaScript: the universal entry. It runs in
...
// the public API is `moderator.js` (shared with the native entry). For a prebuilt
// native server core (no @litertjs/core, best server throughput), import
// `@desert-ant-labs/moderator/native`.
//
