...
// Redact's host/exports globals and dist entry points. Bundlers resolve this
// file only through the non-browser ("default") condition of `#platform`, so
// the browser bundle never sees `node:*`.
//
