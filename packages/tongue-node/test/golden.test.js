...
test("detection output matches the reference head", async () => {
  // Without these, nothing in any port asserts a probability, and the ports can
  // disagree on `language` while every suite stays green. Generated by
  // scripts/gen_detection_vectors.py, a fourth implementation reading the shipped
  // weights.
