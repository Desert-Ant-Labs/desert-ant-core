...
```swift
.package(url: "https://github.com/Desert-Ant-Labs/desert-ant-core.git", from: "1.0.2")
```
...
// build.gradle.kts
dependencies {
    implementation("ai.desertant:emo:1.0.2")
    implementation("ai.desertant:redact:1.0.2")
}
```
