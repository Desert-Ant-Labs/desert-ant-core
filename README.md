...
| **Cue** | On-device voice activity detection: frame-precise speech spans, any language. | Apple | [SDK](https://github.com/Desert-Ant-Labs/desert-ant-core/blob/main/docs/models/cue.md) [Model](https://huggingface.co/desert-ant-labs/cue) |
